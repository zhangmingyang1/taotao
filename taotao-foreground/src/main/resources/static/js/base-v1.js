 ...
 */
function login() {
    return location.href = "http://127.0.0.1:8084/user/login";
}
function regist() {
    return location.href = "http://127.0.0.1:8084/user/register";
}
...
function search(a) {
    var b = "http://127.0.0.1:8080/solr/query?key=" + encodeURIComponent(document.getElementById(a).value);
